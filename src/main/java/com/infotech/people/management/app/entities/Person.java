...
@DynamicUpdate
/*@NamedQueries(value = { 						//here in JPQL we used Entity name as table name and its property as column name
...
*/
@NamedNativeQueries(value = { 			//But in SQL query we have to use actual table name and its column names, and last attributes is a hint to Spring data JPA to bind query result with Person entity class
